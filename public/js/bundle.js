    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)("error", _context2.t0.res.data.message);
        case 11:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "password" ? "/api/v1/users/updateMyPassword" : "/api/v1/users/updateMe"; // console.log(data);
          _context.next = 4;
          return (0, _axios.default)({
            method: "PATCH",
            url: url,
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", "Update date has failed");
        case 11:
        case "end":
          return _context.stop();
      }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe("pk_test_51OP4VoDCnw9REc2PDG1MQPKDPelSAyJqF5RWzbRuDY2RDduD4DgDFS2fOIsbKqYiCBHD09o1xCahtWasSeSKnRie00HLS8ZMRb");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          break;
        case 9:
          console.error("Session data is undefined or does not have the expected structure.");
        case 10:
          _context.next = 17;
          break;
        case 12:
          ...
          if (_axios.default.isAxiosError(_context.t0)) {
            ...
            console.error("AxiosError:", _context.t0.response.status, _context.t0.response.data);
          } else {
            // Handle non-Axios errors
            console.error("Non-Axios error:", _context.t0.message);
          }
        case 17:
        case "end":
          return _context.stop();
